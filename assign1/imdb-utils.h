...
const std::string kIMDBDataDirectory("/home/john/cs110/samples/assign1/");
...
struct film {
   ...
   * lexicographically less than the second title, or if their titles are the
   * same but the first's year is precedes the second's.
   *
